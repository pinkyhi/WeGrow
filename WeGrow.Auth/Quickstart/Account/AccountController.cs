...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                var thisEmailUser = await _signInManager.UserManager.FindByEmailAsync(model.Email);
                if(thisEmailUser != null)
                {
                    ModelState.AddModelError("Not unique email", "This email is occupied");
                }
                else
                {
                    var registerUser = await _signInManager.UserManager.CreateAsync(
                    new IdentityUser
                    {
